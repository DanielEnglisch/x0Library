...
/**
 * <h3>A class to build command strings which can be used as input for the CommandParser.</h3>
 */
public class CommandBuilder {
	...
	/**
	 * 
	 * @param head Head of the command (e.g <b>apt-get</b> update)
	 * @param arg_prefix Prefix of upcoming arguments (e.g <b>-</b> or <b>/</b>) Default: -
	 * @param flag_prefix Prefix of upcoming flags (e.g <b>--</b> or <b>#</b>) Default: --
	 */
	 ...
	 * @param name Name of the argument (e.g -<b>name</b> '<b>value</b>')
	 * @param value Value of the argument (e.g -<b>name</b> '<b>value</b>')
	 ...
	 * @param name Name of the flag (e.g --<b>name</b>)
	 * @return Adjusted version of CommandBuilder
	 */
	 ...
	 * @param value Simple value to add to the command string (e.g <b>csgo</b>)
	 * @return Adjusted version of CommandBuilder
	 */
